...
class KelahiranDataTable extends DataTable
{
    ...
    protected function getColumns(): array
    {
        return [
            ...
            Column::make('name')->title('NAMA BAYI')->addClass('text-left')->searchable(true)->orderable(true),
            Column::make('jenis_kelamin')->title('JK')->addClass('text-center')->searchable(false)->orderable(true),
            Column::make('tanggal_lahir')->title('TL')->addClass('text-center')->searchable(true)->orderable(true),
            Column::make('tempat_lahir')->title('TEM L')->addClass('text-left')->searchable(true)->orderable(true),
            Column::make('nama_ayah')->title('NAMA AYAH')->addClass('text-left')->searchable(false)->orderable(false),

<x-backend-layout>
    ...
    <x-card label="Tabel Kelahiran">
        <x-slot name="button">
            <a href="{{ route('kelahiran.create') }}" class="btn btn-primary modal-show" title="Tambah">
    ...
    @push('script')
        ...
        <script>
            ...
            $('body').on('click', '.modal-show', function(event) {
                ...
                $('#modal-title').text(title + ' Kelahiran');
                $('#modal-btn-save')
            ...
            $('body').on('click', '.btn-delete', function(event) {
                ...
                swal({
                        title: 'Apakah anda ingin menghapus data kelahiran?',
                        text: '',
                        icon: 'warning',
                        buttons: true,
                        dangerMode: true,

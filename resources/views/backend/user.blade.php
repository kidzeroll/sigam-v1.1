<x-backend-layout>
    ...
    <x-card label="Tabel User">
        <x-slot name="button">
            <a href="{{ route('user.create') }}" class="btn btn-primary modal-show" title="Tambah">
    ...
    @push('script')
        ...
        <script>
            ...
            $('body').on('click', '.btn-delete', function(event) {
                ...
                swal({
                        title: 'Apakah anda ingin menghapus user?',
                        text: '',
                        icon: 'warning',
                        buttons: true,
                        dangerMode: true,

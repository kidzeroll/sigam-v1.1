<x-backend-layout>
    ...
    <x-card label="Tabel Pendatang">
        <x-slot name="button">
            <a href="{{ route('pendatang.create') }}" class="btn btn-primary modal-show" title="Tambah">
                <i class="fas fa-plus-circle"></i>
                <span>Tambah Data Pendatang</span>
            </a>
        </x-slot>
    ...
    @push('script')
        ...
        <script>
            ...
            $('body').on('click', '.btn-delete', function(event) {
                ...
                swal({
                        title: 'Apakah anda ingin menghapus data pendatang?',
                        text: '',
                        icon: 'warning',
                        buttons: true,
                        dangerMode: true,

<x-backend-layout>
    <x-slot name="title">Penduduk</x-slot>

    <x-card label="Tabel penduduk">
        <x-slot name="button">
            <a href="{{ route('penduduk.create') }}" class="btn btn-primary modal-show" title="Tambah">
    ...
    @push('script')
        ...
        <script>
            ...
            $('body').on('click', '.modal-show', function(event) {
                ...
                $('#modal-title').text(title + ' Penduduk');
                $('#modal-btn-save')
            ...
            $('body').on('click', '.btn-delete', function(event) {
                ...
                swal({
                        title: 'Apakah anda ingin menghapus penduduk?',
                        text: '',
                        icon: 'warning',
                        buttons: true,
                        dangerMode: true,
